...
def tkinter_slider():
    root = tk.Tk()
    scale = tk.Scale(root, from_=0, to=100, orient=tk.HORIZONTAL, label="Tkinter Slider")
    scale.pack()
    root.mainloop()

# Run the Tkinter version (you can comment this out if you only want to run VPython)
tkinter_slider()
