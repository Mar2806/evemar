...
def version_1():
    ...
    # Planeten-Daten
    planets_data = [
        {'name': 'Mercury', 'radius': 0.5, 'color': vector(0.5, 0.5, 0.5), 'orbital_radius': 5, 'orbital_period': 0.24, 'real_radius_km': 2439, 'real_orbital_radius_mio_km': 58},
        {'name': 'Venus',   'radius': 0.8, 'color': vector(1, 0.65, 0),    'orbital_radius': 8, 'orbital_period': 0.62, 'real_radius_km': 6051, 'real_orbital_radius_mio_km': 108},
        {'name': 'Earth',   'radius': 1.0, 'color': vector(0, 0, 1),       'orbital_radius': 12, 'orbital_period': 1.0,  'real_radius_km': 6371, 'real_orbital_radius_mio_km': 150},
        {'name': 'Mars',    'radius': 0.6, 'color': vector(1, 0, 0),       'orbital_radius': 16, 'orbital_period': 1.88, 'real_radius_km': 3389, 'real_orbital_radius_mio_km': 228},
        {'name': 'Jupiter', 'radius': 1.8, 'color': vector(0, 1, 1),       'orbital_radius': 25, 'orbital_period': 11.86, 'real_radius_km': 69911, 'real_orbital_radius_mio_km': 778},
        ...
        {'name': 'Neptune', 'radius': 1.1, 'color': vector(0.2, 0.2, 1),   'orbital_radius': 60, 'orbital_period': 164.8, 'real_radius_km': 24622, 'real_orbital_radius_mio_km': 4500}
    ]
