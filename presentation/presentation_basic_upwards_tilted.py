...
orbit_angle = math.radians(60)  # Angle of the orbital plane relative to the sun's motion
...
while True:
    ...
    for i, planet in enumerate(planets):
        ...
        y_orbit = data['orbital_radius'] * math.sin(angles[i] + data['phi_offset']) * math.sin(orbit_angle)  # y-component of the orbit
