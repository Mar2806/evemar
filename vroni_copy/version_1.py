...
# UI-Elemente unterhalb des 3D-Fensters anzeigen
  ...
  def planet_clicked(evt):
    ...
    if clicked_object and hasattr(clicked_object, 'name'):
  ...
  while True:
      rate(max(1, time_speed))  # Bei time_speed=0 pausiert es effektiv

      if paused:
          continue  # Wenn pausiert, keine Positionsupdates
...
# Pausieren beim Klick auf einen Planeten
